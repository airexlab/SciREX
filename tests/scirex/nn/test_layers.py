...
from scirex.nn.layers.normalisation import LayerNorm, BatchNorm, RMSNorm
...
class TestSequential:
    ...
    def test_sequential_creation(self):
        ...
        rngs = nnx.Rngs(0)
        layers = [
            Linear(in_features=10, out_features=5, rngs=rngs),
            Linear(in_features=5, out_features=2, rngs=rngs)
        ]
