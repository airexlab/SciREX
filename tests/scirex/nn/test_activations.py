...
class TestActivationProperties:
    ...
    def test_all_activations_should_preserve_shape(self):
        ...
        activations_to_test = [
            activations.relu, activations.sigmoid, activations.gelu,
            activations.elu, activations.selu, activations.swish,
            activations.mish, activations.softplus
        ]
    ...
    def test_activations_should_handle_zero_input(self):
        ...
        activations_to_test = [
            activations.relu, activations.sigmoid, activations.gelu,
            activations.elu, activations.swish, activations.mish
        ]
    ...
    def test_activations_should_handle_large_positive_values(self):
        ...
        activations_to_test = [
            activations.relu, activations.relu6, activations.gelu,
            activations.elu, activations.swish
        ]
