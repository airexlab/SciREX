...
Dependencies:
    ...
    - scirex.experimental.ml.unsupervised.clustering.kmeans.NaiveBayes
...
import numpy as np
from scirex.experimental.ml.supervised.classification.naive_bayes import NaiveBayes
...
class TestNaiveBayes(unittest.TestCase):
    ...
    def test_bernoulli_naive_bayes(self):
        ...
        X_binary = np.where(np.median(self.X, axis=0) < self.X, 1, 0)
