...
import optax
import pytest
from scirex.experimental.sciml.fno.layers.fno_block_1d import FNOBlock1d
from scirex.experimental.sciml.fno.layers.fno_block_2d import FNOBlock2d
from scirex.experimental.sciml.fno.layers.spectral_conv_1d import SpectralConv1d
from scirex.experimental.sciml.fno.layers.spectral_conv_2d import SpectralConv2d
from scirex.experimental.sciml.fno.models.fno_1d import FNO1d
from scirex.experimental.sciml.fno.models.fno_2d import FNO2d
...
class TestSpectralConv2d:
    def test_initialization(self, rng_key):
        ...
        layer = SpectralConv2d(in_channels=2, out_channels=4, modes1=8, modes2=8, key=rng_key)
    ...
    def test_fourier_mode_multiplication(self, rng_key):
        ...
        layer = SpectralConv2d(in_channels=1, out_channels=1, modes1=4, modes2=4, key=rng_key)
