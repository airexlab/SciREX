...
from scirex.experimental.dl.jax_backend.equinox import layers, losses, activations, utils
from scirex.experimental.dl.jax_backend.equinox.base import Model, Network
from scirex.experimental.dl.jax_backend.equinox.networks import FCNN
