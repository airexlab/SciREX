...
```python
from scirex.experimental.dl import Model, Network
import scirex.experimental.dl.nn as nn
...
from scirex.experimental.dl import Model, Network
from scirex.experimental.dl.nn.loss import cross_entropy_loss
from scirex.experimental.dl.nn.metrics import accuracy
...
```python
# Import required modules
from scirex.experimental.dl import Model, Network, FCNN
