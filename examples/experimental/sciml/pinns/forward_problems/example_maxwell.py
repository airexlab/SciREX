...
from scirex.experimental.sciml.pinns.model.model_vector_transient import DenseModel
from scirex.experimental.sciml.pinns.physics.maxwell import pde_loss_maxwell
