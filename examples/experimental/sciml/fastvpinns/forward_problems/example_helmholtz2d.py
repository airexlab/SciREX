...
from scirex.experimental.sciml.fastvpinns.model.model import DenseModel
from scirex.experimental.sciml.fastvpinns.physics.helmholtz2d import pde_loss_helmholtz
